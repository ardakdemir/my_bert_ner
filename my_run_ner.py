...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["I-LOC", "I-PER","I-ORG", "O", "X", "[CLS]", "[SEP]"] 
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # def metric_fn(label_ids, logits):
                ...
                precision = tf_metrics.precision(label_ids,predictions,num_labels,[1,2,3],average="macro")
                recall = tf_metrics.recall(label_ids,predictions,num_labels,[1,2,3],average="macro")
                f = tf_metrics.f1(label_ids,predictions,num_labels,[1,2,3],average="macro")
                #
                return {
